    ...
    <div className="p-8 max-w-6xl">
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        {[
          ...
          { label: "Готово", value: stats.done, color: "text-green-400" },
          { label: "Ошибка", value: stats.error, color: "text-red-400" },
          { label: "Ожидание", value: stats.pending, color: "text-yellow-400" },
        ].map(s => (
